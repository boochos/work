#libs
downloadlibs = ['download_lib.py', 'downloadFiles_lib.py','fileMan_lib', 'characterSet_lib.py', 'characterUI_macro_lib.py', 'constraint_lib.py',
...
#icons
downloadIcons = ['constraintUI.png', 'csAdd.png', 'csEx.png',
