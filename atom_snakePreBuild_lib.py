...
def snakePreBuild(
    ...
    # COG #
    Cog = 'A'
    cog = place.Controller(Cog, COG_jnt, False, 'facetZup_ctrl', X * 35, 12, 8, 1, (0, 0, 1), True, True)
    CogCt = cog.createController()
    Up = place.circle(Cog + '_Upper', CogCt[3], 'splineStart_ctrl', X * 7, 12, 8, 1, (0, 0, 1))[0]
    Low = place.circle(Cog + '_Lower', CogCt[3], 'splineEnd_ctrl', X * 7, 12, 8, 1, (0, 0, 1))[0]
    cmds.parent(Up, CogCt[3])
    cmds.parent(Low, CogCt[3])
    place.setChannels(Up, [True, False], [True, False], [True, False], [True, False, False])
    place.setChannels(Low, [True, False], [True, False], [True, False], [True, False, False])
    place.addText(CogCt[2], t=Cog, c=12, rotOffset=[0, 0, 0], posOffset=[-1, 12, 0])
    place.setRotOrder(CogCt[0], 2, True)
    place.setRotOrder(CogCt[2], 3, False)
    ...
    for joint in UPPER_jnt:
        if cmds.objExists(joint):
            ...
            place.parentSwitch(Upper, UpperCt[2], UpperCt_CtGrp1, UpperCt_TopGrp1, MasterCt[4], parent, False, False, True, True, '')
            place.parentSwitch(Upper, UpperCt[2], UpperCt[1], UpperCt[0], MasterCt[4], parent, False, True, False, False, '')
    ...
    for joint in LOWER_jnt:
        if cmds.objExists(joint):
            if i == 0:
                ...
                parent = joint[:5] + chr(ord('a') + i).upper() + '_Grp'
            Lower = joint[:6]
            lowerMaster = place.Controller(Lower, joint, True, 'facetZup_ctrl', X * 25, 17, 8, 1, (0, 0, 1), True, True)
            LowerCt = lowerMaster.createController()
            place.addText(LowerCt[2], t=joint[5], c=17, rotOffset=[0, 180, 0], posOffset=[1.5, 8, 0])
            cmds.parent(LowerCt[0], CONTROLS)
            cmds.select(LowerCt[0])
            LowerCt_TopGrp1 = place.insert('null', 1, Lower + '_TopGrp1')[0][0]
            LowerCt_CtGrp1 = place.insert('null', 1, Lower + '_CtGrp1')[0][0]
            place.setRotOrder(LowerCt_TopGrp1, 2, True)
            place.setRotOrder(LowerCt[2], 3, False)
            place.parentSwitch(Lower, LowerCt[2], LowerCt_CtGrp1, LowerCt_TopGrp1, MasterCt[4], parent, False, False, True, True, '')
            place.parentSwitch(Lower, LowerCt[2], LowerCt[1], LowerCt[0], MasterCt[4], parent, False, True, False, False, '')
            cmds.parentConstraint(parent, LowerCt_TopGrp1, mo=True)
            place.setChannels(LowerCt[0], [False, False], [False, False], [True, False], [True, False, False])
            place.setChannels(LowerCt[1], [False, True], [False, False], [True, False], [True, False, False])
            place.setChannels(LowerCt[2], [False, True], [False, True], [True, False], [True, False, False])
            place.setChannels(LowerCt[3], [False, True], [False, True], [True, False], [False, False, False])
            cmds.setAttr(LowerCt[3] + '.visibility', cb=False)
            place.setChannels(LowerCt[4], [True, False], [False, True], [True, False], [True, False, False])
            i = i + 1

    # LOWER TIP #
    if cmds.objExists(LOWERTIP_jnt):
        LowerTip = 'lowerTip'
        lowerTip = place.Controller(LowerTip, LOWERTIP_jnt, True, 'facetZup_ctrl', X * 25, 12, 8, 1, (0, 0, 1), True, True)
        LowerTipCt = lowerTip.createController()
        cmds.parent(LowerTipCt[0], CONTROLS)
        place.setRotOrder(LowerTipCt[0], 2, True)
        # parent switches
        parent = LOWER_jnt[len(LOWER_jnt) - 1][:6] + '_Grp'
        place.parentSwitch(LowerTip, LowerTipCt[2], LowerTipCt[1], LowerTipCt[0], MasterCt[4], parent, False, False, True, True, '')
        cmds.parentConstraint(parent, LowerTipCt[0], mo=True)
        place.setChannels(LowerTipCt[0], [False, False], [False, False], [True, False], [True, False, False])
        place.setChannels(LowerTipCt[1], [False, False], [False, False], [True, False], [True, False, False])
        place.setChannels(LowerTipCt[2], [False, True], [False, True], [True, False], [True, False, False])
        place.setChannels(LowerTipCt[3], [False, True], [False, True], [True, False], [False, False, False])
        cmds.setAttr(LowerTipCt[3] + '.visibility', cb=False)
        place.setChannels(LowerTipCt[4], [True, False], [False, True], [True, False], [True, False, False])
    else:
        LowerTipCt = None
    ...
    place.setRotOrder(NeckCt[2], 2, False)
    # parent switches
    ...
    place.setRotOrder(D_Attch_CnstGp, 2, False)
    cmds.parentConstraint(parent, D_Attch_Gp, mo=True)
    cmds.parent(D_Attch_Gp, NeckCt[0])
    place.parentSwitch(Neck, NeckCt[2], NeckCt[1], NeckCt[0], MasterCt[4], D_Attch_CnstGp, False, True, False, True, '')
    ...
    place.setRotOrder(HeadCt[2], 2, False)
    # parent switch
    place.parentSwitch(Head, HeadCt[2], HeadCt[1], HeadCt[0], MasterCt[4], NeckCt[4], False, True, False, True, '')
    ...
    NeckCt = neck.createController()
    place.addText(NeckCt[2], t=Neck[5], c=17, rotOffset=[0, 0, 0], posOffset=[-1, 12, 0])
    cmds.select(NeckCt[0])
    NeckCt_TopGrp1 = place.insert('null', 1, Neck + '_TopGrp1')[0][0]
    NeckCt_CtGrp1 = place.insert('null', 1, Neck + '_CtGrp1')[0][0]
    place.setRotOrder(NeckCt_TopGrp1, 2, True)
    place.setRotOrder(NeckCt[2], 3, False)
    # parent switches
    parent = UPPER_jnt[len(UPPER_jnt) - 1][:6] + '_Grp'
    place.parentSwitch(Neck, NeckCt[2], NeckCt_CtGrp1, NeckCt_TopGrp1, MasterCt[4], parent, False, False, True, True, '')
    place.parentSwitch(Neck, NeckCt[2], NeckCt[1], NeckCt[0], MasterCt[4], parent, False, True, False, False, '')
    cmds.parentConstraint(parent, NeckCt_TopGrp1, mo=True)
    place.setChannels(NeckCt[0], [False, False], [False, False], [True, False], [True, False, False])
    place.setChannels(NeckCt[1], [True, False], [False, False], [True, False], [True, False, False])
    place.setChannels(NeckCt[2], [False, True], [False, True], [True, False], [True, False, False])
    place.setChannels(NeckCt[3], [False, True], [False, True], [True, False], [False, False, False])
    cmds.setAttr(NeckCt[3] + '.visibility', cb=False)
    place.setChannels(NeckCt[4], [True, False], [True, False], [True, False], [True, False, False])
    # parent topGp to master
