...
def snakePreBuild(
    ...
    misc.setChannels(Low, [True, False], [True, False], [True, False], [True, False, False])
    misc.addText(CogCt[2], t=Cog, c= 12, rotOffset=[0,0,0], posOffset=[-1,12,0])
    ...
    for joint in LOWER_jnt:
        if cmds.objExists(joint):
            ...
            misc.addText(LowerCt[2], t=joint[5], c= 17, rotOffset=[0,180,0], posOffset=[1.5,8,0])
            cmds.parent(LowerCt[0], CONTROLS)
            cmds.select(LowerCt[0])
            LowerCt_TopGrp1 = misc.insert('null', 1, Lower + '_TopGrp1')[0][0]
            LowerCt_CtGrp1  = misc.insert('null', 1, Lower + '_CtGrp1')[0][0]
            misc.setRotOrder(LowerCt_TopGrp1, 2, True)
            misc.setRotOrder(LowerCt[2], 3, False)
            misc.parentSwitch(Lower, LowerCt[2], LowerCt_CtGrp1, LowerCt_TopGrp1, MasterCt[4], parent, False, False, True, True, '')
            misc.parentSwitch(Lower, LowerCt[2], LowerCt[1], LowerCt[0], MasterCt[4], parent, False, True, False, False, '')
            cmds.parentConstraint(parent, LowerCt_TopGrp1, mo=True)
            misc.setChannels(LowerCt[0], [False, False], [False, False], [True, False], [True, False, False])
            misc.setChannels(LowerCt[1], [False, True], [False, False], [True, False], [True, False, False])
            misc.setChannels(LowerCt[2], [False, True], [False, True], [True, False], [True, False, False])
            misc.setChannels(LowerCt[3], [False, True], [False, True], [True, False], [False, False, False])
            cmds.setAttr(LowerCt[3] + '.visibility', cb=False)
            misc.setChannels(LowerCt[4], [True, False], [False, True], [True, False], [True, False, False])
            i = i+1
    ...
    if cmds.objExists(LOWERTIP_jnt):
        ...
        misc.setRotOrder(LowerTipCt[0], 2, True)
        ##parent switches
        parent =  LOWER_jnt[len(LOWER_jnt) -1][:6] + '_Grp'
        misc.parentSwitch(LowerTip, LowerTipCt[2], LowerTipCt[1], LowerTipCt[0], MasterCt[4], parent, False, False, True, True, '')
        cmds.parentConstraint(parent, LowerTipCt[0], mo=True)
        misc.setChannels(LowerTipCt[0], [False, False], [False, False], [True, False], [True, False, False])
        misc.setChannels(LowerTipCt[1], [False, False], [False, False], [True, False], [True, False, False])
        misc.setChannels(LowerTipCt[2], [False, True], [False, True], [True, False], [True, False, False])
        misc.setChannels(LowerTipCt[3], [False, True], [False, True], [True, False], [False, False, False])
        cmds.setAttr(LowerTipCt[3] + '.visibility', cb=False)
        misc.setChannels(LowerTipCt[4], [True, False], [False, True], [True, False], [True, False, False])
    else:
        LowerTipCt = None
