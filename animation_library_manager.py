...
class AnimationExportManager(object):
    ...
    def getExportPath(self):
        ...
        '''
        basePath = 'C:/Users/Slabster & Vicster/Documents/maya'
        project  = 'animation'
        user     = getEnv('USER')
        if os.path.exists(basePath):
            ...
            wStr= 'Base Path not found, expecting: %s' %(basePath)
            openMaya.MGlobal.displayWarning(wStr)
        ...
        if exportName != 'None':
            ...
            if not os.path.exists(exportPath):
                if len(ls(sl=True)) > 0:
                    ...
                    AnimationToolbox(path=os.path.join(exportPath, exportName), fRange = fRange).animExport()
                else:
...
class AnimationImportManager(object):
    ...
    def setImportPath(self):
        ...
        project  = 'animation'
        user     = getEnv('USER')
        pubPath = 'C:/Users/Slabster & Vicster/Documents/maya/animationPublished'
