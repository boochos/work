import os, sys, threading, time, traceback, subprocess
import functools, string, random, tempfile
...
def run():
    ...
    app.setWindowIcon( ( QIcon( 'C:\Program Files\Python27\Lib\site-packages\key_base\art\icons\playGreen.png' ) ) )
