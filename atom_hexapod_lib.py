...
import atom_appendage_lib as appendage
import maya.cmds as cmds
def hexapod(*args):
	
	#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	#creates groups and master controller from arguments specified as 'True'
	misc.rigPrebuild(Top=0, Ctrl=True, SknJnts=True, Geo=True, World=True, Master=True, OlSkool=True, Size=12)
	...
	for jnt in endJntL:
		...
		cmds.parentConstraint('master_Grp',cntCt[0],mo=True)
		#add pv attributes
		misc.optEnum(cntCt[2], attr=assist, enum='OPTNS')
	...
	for jnt in legJntL:
		...
		misc.cleanUp(pvLocListL[i], Ctrl=True, SknJnts=False, Body=False, Accessory=False, Utility=False, World=False, olSkool=False)
		i=i+1
	...
	for jnt in legJntR:
		...
		misc.cleanUp(pvLocListR[i], Ctrl=True, SknJnts=False, Body=False, Accessory=False, Utility=False, World=False, olSkool=False)
		i=i+1
	...
	*\n
	...
	misc.cleanUp('GuideGp', Ctrl=False, SknJnts=False, Body=False, Accessory=False, Utility=False, World=True, olSkool=False)
	...
	misc.cleanUp('root_jnt', Ctrl=False, SknJnts=True, Body=False, Accessory=False, Utility=False, World=False, olSkool=False)
	
	misc.cleanUp('body_Geo', Ctrl=False, SknJnts=False, Body=True, Accessory=False, Utility=False, World=False, olSkool=False)
