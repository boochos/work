...
class NameDialog_v01( object ):
    ...
    def __init__( self, intWinName, visWinName, buttonLabel ):
        ...
        visWinName<string> : Visible name of the window\n
    ...
    def buildNameContents( self ):
        ...
        # Scene
        self.scene = self.NameIntSliderGrp( self.intWinName + '_scene', 'Scene:', 3, 1, cw, 1, 500, self.buildName )
        self.scene.intSliderGrp()
        # Shot
        self.shot = self.NameIntSliderGrp( self.intWinName + '_shot', 'Shot:', 3, 1, cw, 1, 500, self.buildName )
