...
class SliderCore( object ):
    ...
    def calculate_blend( self, curve, time, blend_factor ):
        ...
        try:
            ...
            if isinstance( current_strategy, slider_strategies_blending.GeometricBlendStrategy ):
...
class BlendData:
    ...
    def __init__( self ):
        ...
        self.current_values = {}  # Current values per curve/time
