...
class CharacterSetManagerUI( QWidget ):
    ...
    def create_widgets( self ):
        ...
        self.import_button.setStyleSheet( """
            QPushButton {
                background-color: rgb(90, 135, 90);
                border: none;
                border-radius: 2px;
            ...
            QPushButton:pressed {
                background-color: rgb(80, 125, 80);
            }
        """ )
    ...
    def create_layouts( self ):
        ...
        title_bar.setStyleSheet( """
            background-color: rgb(119, 108, 65 );
            border-radius: 2px;
        """ )
        ...
        # Add title label
        title_label = QLabel( "Character  Set  Manager".upper() )
        ...
        close_button.setStyleSheet( """
            ...
            QPushButton:hover {
                background-color: rgb(182, 156, 54);
            }
        """ )
