...
def quadPreBuild(
	...
	for item in attrVis:
	    ...
	    misc.setRotOrder(TailCt[0], 2, True)
	    misc.parentSwitch(Tail, TailCt[2], TailCt[1], TailCt[0], CogCt[4], PelvisAttch_CnstGp, False, True, False, True, 'Pelvis')
	    cmds.parentConstraint(PelvisAttch_CnstGp, TailCt[0], mo=True)
	    misc.setChannels(TailCt[0], [False, False], [False, False], [True, False], [True, False, False])
	    misc.setChannels(TailCt[1], [True, False], [False, False], [True, False], [True, False, False])
	    misc.setChannels(TailCt[2], [True, False], [False, True], [True, False], [True, False, False])
	    misc.setChannels(TailCt[3], [True, False], [False, True], [True, False], [False, False, False])
	    cmds.setAttr(TailCt[3] + '.visibility', cb=False)
	    misc.setChannels(TailCt[4], [True, False], [False, True], [True, False], [True, False, False])
	else:
	    TailCt = None
	...
	if cmds.objExists(TAILTIP_jnt):
	    ...
	    misc.setRotOrder(TailTipCt[0], 2, True)
	    misc.parentSwitch(TailTip, TailTipCt[2], TailTipCt[1], TailTipCt[0], CogCt[4], TailCt[4], False, False, True, True, 'Tail', 0)
	    cmds.parentConstraint(TailCt[4], TailTipCt[0], mo=True)
	    misc.setChannels(TailTipCt[0], [False, False], [False, False], [True, False], [True, False, False])
	    misc.setChannels(TailTipCt[1], [False, False], [False, False], [True, False], [True, False, False])
	    misc.setChannels(TailTipCt[2], [False, True], [False, True], [True, False], [True, False, False])
	    misc.setChannels(TailTipCt[3], [False, True], [False, True], [True, False], [False, False, False])
	    cmds.setAttr(TailTipCt[3] + '.visibility', cb=False)
	    misc.setChannels(TailTipCt[4], [True, False], [False, True], [True, False], [True, False, False])
	else:
	    TailTipCt = None
