...
def clusterGroup(prefix, X, skinJnts, aim, up, rotate):
	if len(skinJnts) > 2:
		...
		misc.cleanUp(MstrPrfx, Ctrl=True)
		cmds.setAttr((S_MstrSplnGrp + '.visibility'), 0)
		cmds.setAttr((E_MstrSplnGrp + '.visibility'), 0)
		cmds.setAttr((ClstrGrp + '.visibility'), 0)
		##setChannels
		misc.setChannels(MstrPrfx, [True, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(S_MstrSplnGrp, [True, False], [True, False], [True, False], [False, False, False])
		misc.setChannels(E_MstrSplnGrp, [True, False], [True, False], [True, False], [False, False, False])
		misc.setChannels(SplnCtrlGrp, [True, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(ClstrGrp, [False, False], [False, False], [True, False], [False, False, False])
...
def clusterControlGroup(prefix, suffix, X, aim, buildControls, skinJnts, rotOrder, function, F, BUS_clusterGrps_Sjnt_Ejnt_Sblnd_Eblnd_Crv_Sik_Eik_SplnCtrlGrp_ClstrGrp):
	...
	if len(BUS_clusterGrps_Sjnt_Ejnt_Sblnd_Eblnd_Crv_Sik_Eik_SplnCtrlGrp_ClstrGrp[0]) > 2:
		...
		##cluster group attrs
		misc.setChannels(ClstrCtrlGrp, [False, False], [False, False], [True, False], [True, False, False])
		misc.addAttribute(ClstrCtrlGrp, suffix[1:] + 'Vis', 0, 1, 0, 'long')
		attrList = [suffix[1:] + 'MidSEPosWeight', suffix[1:] + 'MidIkBlend', suffix[1:] + 'MidIkSE_W', suffix[1:] + 'TangentVis', suffix[1:] + 'Vis']
		misc.addAttribute(ClstrCtrlGrp, attrList[3], 0, 1, 0, 'long')
		misc.addAttribute(ClstrCtrlGrp, attrList[:3], 0, 1, 1, 'double')
		...
		Spr = misc.insert('null',1,((prefix + suffix + '_S_PrntGrp')))[0]
		cmds.select(Spr)
		Sps = misc.insert('null',1,((prefix + suffix + '_S_PosGrp')))[0]
		#cmds.setAttr(Sps[0] + '.rotateOrder', rotOrder)
		misc.setChannels(Sps[0], [False, False], [False, False], [True, False], [True, False, False])
		ClusterCntrlGrps.append(Sps[0])
		cmds.parent(Sps, ClstrCtrlGrp)
		cmds.select(Sloc)
		SMps = misc.insert('null',0,((prefix + suffix + '_S_M_PosGrp')))[0]
		...
		cmds.select(Eloc) 
		Epr = misc.insert('null',1,((prefix + suffix + '_E_PrntGrp')))[0]
		cmds.select(Epr)
		Eps = misc.insert('null',1,((prefix + suffix + '_E_PosGrp')))[0]
		#cmds.setAttr(Eps[0] + '.rotateOrder', rotOrder)
		misc.setChannels(Eps[0], [False, False], [False, False], [True, False], [True, False, False])
		##clusterCntrlGrps.append(Eps[0]) added at the end for order consistency
		cmds.parent(Eps, ClstrCtrlGrp)
		cmds.select(Eloc)
		EMps = misc.insert('null',0,((prefix + suffix + '_E_M_PosGrp')))[0]
		...
		MMpr = misc.insert('null',1,(prefix + suffix + '_M' + num + '_PrntGrp'))[0][0]
		cmds.select(MMpr)
		MMps = misc.insert('null',1,(prefix + suffix + '_M' + num + '_PosGrp'))[0]
		...
		cmds.select(MMloc)
		MMMps = misc.insert('null',0,(prefix + suffix + 'M_M' + num + '_PosGrp'))[0]
		...
		#Set Channels
		misc.setChannels(MMps[0], [False, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(MMpr, [False, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(Spr[0], [False, False], [False, False], [True, False], [True, False, False])
		misc.setChannels(Epr[0], [False, False], [False, False], [True, False], [True, False, False])
		...
		for i in range(0, len(S_M), 1):
			if i == 0:
				...
				Mpr = misc.insert('null',1,(prefix + suffix + '_M' + str(jj) + '_PrntGrp'))[0]
				...
				cmds.select(Mpr)
				Mps = misc.insert('null',1,(prefix + suffix + '_M' + str(jj) + '_PosGrp'))[0]
				...
				#Set Channels
				misc.setChannels(Mloc, [False, True], [False, False], [True, False], [True, False, False])
				misc.setChannels(Mpr[0], [False, False], [True, False], [True, False], [True, False, False])
				misc.setChannels(Sprn, [False, False], [True, False], [True, False], [True, False, False])
				misc.setChannels(MMprn, [False, False], [True, False], [True, False], [True, False, False])
				##
				jj = jj + 1
		jj = jj + 1
		...
		for i in range(0, len(M_E), 1):
			if i == 0:
				...
				misc.setChannels(Mloc, [False, True], [False, False], [True, False], [True, False, False])
				misc.setChannels(Mpr[0], [False, False], [True, False], [True, False], [True, False, False])
				misc.setChannels(Eprn, [False, False], [True, False], [True, False], [True, False, False])
				misc.setChannels(MMprn, [False, False], [True, False], [True, False], [True, False, False])
				##
		...
		misc.setChannels(guideGrp,[True, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(guideClstr,[True, False], [True, False], [True, False], [True, False, False])
		misc.setChannels(guideCrv,[True, False], [True, False], [True, False], [False, False, False])
		##create guides
		for i in range(0, len(Controls)-1, 1):
			CrvCls = misc.guideLine(Controls[i], Controls[i+1], prefix + suffix + '_Guide')
			cmds.parent(CrvCls[0], guideCrv)
			cmds.parent(CrvCls[1], guideClstr)
			misc.setChannels(CrvCls[0],[False, False], [False, False], [False, False], [True, False, False])
			misc.setChannels(CrvCls[1][0],[False, False], [False, False], [False, False], [False, False, False])
			misc.setChannels(CrvCls[1][1],[False, False], [False, False], [False, False], [False, False, False])			
		#
		...
		for i in range(0, len(ClusterCntrls), 1):
			##Start
			if i == 0:
				misc.setChannels(ClusterCntrls[i], [False, True], [False, True], [True, False], [True, False, False])
...
def ikGroup(prefix, X, skinJnts, rotOrder, BUS_clusterGrps_Sjnt_Ejnt_Sblnd_Eblnd_Crv_Sik_Eik_SplnCtrlGrp_ClstrGrp, BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP):
	...
	misc.addAttribute(grp, prefixPlus, 0, 1, 0, 'long')
	cmds.connectAttr((grp + '.' + prefixPlus), (grp + '.visibility'), f=True)
	cmds.setAttr(grp + '.' + prefixPlus, 1)
	attrList = [prefix + 'Root', prefix + 'Stretch']
	misc.addAttribute(grp, attrList, 0, 1, 1, 'double')
	##add attrs from cluster group
	misc.hijackCustomAttrs(BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP[1], grp)
	#Hierarchy
	...
	##setChannels
	#misc.setChannels(BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP[1], [False, False], [False, False], [True, False], [True, False, False])
	...
	for i in range(0, len(skinJnts), 1):
		if i == 0:
			...
			SEprnt[0] = prnt[0]
			misc.setChannels(prnt[0], [False, True], [False, True], [True, False], [True, False, False])
			...
			misc.setChannels(ctrl, [False, True], [False, True], [True, False], [True, False, False])
			misc.setChannels(ctrlOfst, [False, True], [False, True], [True, False], [True, False, False])
			...
			##
			##option attrs
			misc.addAttribute(ctrl, OptAttrs[0], 0, 1, True, 'float')
			'''
			misc.addAttribute(ctrl, OptAttrs[1:], 0, 10, True, 'float')
			cmds.setAttr(ctrl + '.' + OptAttrs[1], 1)
			cmds.setAttr(ctrl + '.' + OptAttrs[2], 1)
			'''
			##offset vis attr
			misc.addAttribute(ctrl, vis, 0, 1, 0, 'long')
...
def upVectorGroup(prefix, X, Y, F, skinJnts, aim, up, aimFloat, upFloat, rotOrder, Constrain, BUS_clusterGrps_Sjnt_Ejnt_Sblnd_Eblnd_Crv_Sik_Eik_SplnCtrlGrp_ClstrGrp, BUS_prnt_vtr_aim_Scnr_Ecnrl_ik_xjnt_cnstrnt_SRblnd_ERblnd_MidB_SEprnt, BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP):
	...
	misc.addAttribute(VectorMaster, MidCnstrnt, 0, 1, True, 'float')
	...
	X1 = misc.insert('null', 0, name[:stringNum - 8] + '_X' + name[-8:])[0][0]
	cmds.select(X1)
	##X2 gets constrained to X1 and mid luster group
	X2 = misc.insert('null', 0, name[:stringNum - 8] + '_XX' + name[-8:])[0][0]
	cmds.select(X2)
	##X3 puts Up vector controller back to correct position
	X3 = misc.insert('null', 0, name[:stringNum - 8] + '_XXX' + name[-8:])[0][0]
	##place X1 X3 groups
	...
	misc.setChannels(ikGrp, [False, False], [False, False], [False, False], [False, False, False])
	cmds.setAttr(ikGrp + '.visibility', cb=False)
	misc.setChannels(BUS_VectorCntrlGrps_VctrCtrlGrp_AttrList_ClusterCntrls_XtraP[1], [False, False], [False, False], [False, False], [False, False, False])
	misc.setChannels(X1, [False, False], [False, False], [True, False], [True, False, False])
	misc.setChannels(X2, [False, False], [False, False], [True, False], [True, False, False])
	misc.setChannels(X3, [False, False], [False, False], [True, False], [True, False, False])
	...
	misc.hijackCustomAttrs(BUS_VectorCntrlGrps_VctrCtrlGrp_AttrList_ClusterCntrls_XtraP[1], ikGrp)
	...
	for i in range(1, len(BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP[0])-1, 1):
		misc.setChannels(BUS_clusterCntrlGrps_ClstrCtrlGrp_AttrList_ClusterCntrls_XtraP[0][i], [False, False], [True, False], [True, False], [True, False, False])
	##vectorControlGroups
	for i in range(1, len(BUS_VectorCntrlGrps_VctrCtrlGrp_AttrList_ClusterCntrls_XtraP[0])-1, 1):
		misc.setChannels(BUS_VectorCntrlGrps_VctrCtrlGrp_AttrList_ClusterCntrls_XtraP[0][i], [False, False], [True, False], [True, False], [True, False, False])
	...
	for i in range(0, len(BUS_prnt_vtr_aim_Scnr_Ecnrl_ik_xjnt_cnstrnt_SRblnd_ERblnd_MidB_SEprnt[0]), 1):
		CrvCls = misc.guideLine(BUS_prnt_vtr_aim_Scnr_Ecnrl_ik_xjnt_cnstrnt_SRblnd_ERblnd_MidB_SEprnt[0][i], BUS_VctrCntrls_BUS[0][i+1], prefix + '_Guide')
		cmds.parent(CrvCls[0], guideCrv)
		cmds.parent(CrvCls[1], guideClstr)
		misc.setChannels(CrvCls[0],[False, False], [False, False], [False, False], [True, False, False])
		misc.setChannels(CrvCls[1][0],[False, False], [False, False], [False, False], [False, False, False])
	...
	if Constrain[0] == True:
		...
		misc.hijackCustomAttrs(ikGrp, Constrain[1])
