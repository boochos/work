...
def preBuild( 
    ...
    if face == False:
        # HIP L #
        hipL = 'hip_L'
        hipL = place.Controller( hipL, HIP_L_jnt, False, 'diamond_ctrl', X * 15, place.colorDict()['darkRed'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        # HIP R #
        hipR = 'hip_R'
        hipR = place.Controller( hipR, HIP_R_jnt, False, 'diamond_ctrl', X * 15, place.colorDict()['darkRed'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        # SHOULDER L #
        shldrL = 'shldr_L'
        shldrL = place.Controller( shldrL, SHLDR_L_jnt, False, 'shldrL_ctrl', X * 15, place.colorDict()['darkRed'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        # SHOULDER R #
        shldrR = 'shldr_R'
        shldrR = place.Controller( shldrR, SHLDR_R_jnt, False, 'shldrR_ctrl', X * 15, place.colorDict()['darkRed'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        # BACK L  #
        PawBckL = 'back_paw_L'
        pawBckL = place.Controller( PawBckL, BACK_L_jnt, False, 'pawMaster_ctrl', X * 17.5, place.colorDict()['blue'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        # BACK R  #
        PawBckR = 'back_paw_R'
        pawBckR = place.Controller( PawBckR, BACK_R_jnt, False, 'pawMaster_ctrl', X * 17.5, place.colorDict()['red'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        pawFrntL = place.Controller( PawFrntL, FRONT_L_jnt, False, 'pawMaster_ctrl', X * 17.5, place.colorDict()['blue'], 8, 1, ( 0, 0, 1 ), True, True )
        ...
        pawFrntR = place.Controller( PawFrntR, FRONT_R_jnt, False, 'pawMaster_ctrl', X * 17.5, place.colorDict()['red'], 8, 1, ( 0, 0, 1 ), True, True )
...
def buildAppendages( *args ):
    ...
    cmds.floatFieldGrp( 'atom_qls_anklePvFlip_floatFieldGrp', edit = True, v2 = 1.25 )  # height
    cmds.floatFieldGrp( 'atom_qls_anklePvFlip_floatFieldGrp', edit = True, v3 = 3.0 )  # forward

    cmds.floatField( 'atom_qls_ldf_floatField', edit = True, v = 3.5 )  # knee pv distance
    cmds.floatField( 'atom_paw_qls_ldf_floatField', edit = True, v = 1 )  # digit pv distance
    ...
    for thumb in thumb_list:
        ...
        place.cleanUp( thumb[0], SknJnts = True )
...
def deform( *args ):
	...
	while i <= 3:
	    ...
	    place.setChannels(ctrl, [False, True], [False, True], [True, False], [True, True,False], [True,True] )
	    i = i + 1
	    '''
        # ABDOMEN
        abdomenName = 'abdomen'
...
def buildRatEars():
    spine = splnFk.SplineFK( 'ear_rig_L', 'root_ear_jnt_L', 'ear_04_jnt_L', 'L', rootParent = 'neck_jnt_06', parent1 = 'neck_jnt_06', ik = 'splineIK' )
    spine = splnFk.SplineFK( 'ear_rig_R', 'root_ear_jnt_R', 'ear_04_jnt_R', 'R', rootParent = 'neck_jnt_06', parent1 = 'neck_jnt_06', ik = 'splineIK' )
    '''
    earBase = None
    if not cmds.objExists('earRig_Grp'):
	earBase = place.null2('earRig_Grp', 'neck_jnt_06')[0]
	place.setRotOrderWithXform(earBase, 'zxy', False)
