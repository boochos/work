...
def atomLockWin(*args):
    ...
    alw_lockButton       = cmds.button('alw_lockButton',      c='from atom import atom_utilities_lib\natom_utilities_lib.lockCmd("alw_checkBoxGrp",True)',    label = 'Lock',    width = width)
    alw_unlockButton     = cmds.button('alw_unlockButton',    c='from atom import atom_utilities_lib\natom_utilities_lib.lockCmd("alw_checkBoxGrp",False)',   label = 'Unlock',  width = width)
    alw_keyableButton    = cmds.button('alw_keyableButton',   c='from atom import atom_utilities_lib\natom_utilities_lib.keyableCmd("alw_checkBoxGrp",True)', label = 'Keyable', width = width)
    alw_nonkeyableButton = cmds.button('alw_nonkeyableButton',c='from atom import atom_utilities_lib\natom_utilities_lib.keyableCmd("alw_checkBoxGrp",False)',label = 'Non-Keyable', width = width)
