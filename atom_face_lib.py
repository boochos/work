...
from key_libs import key_rig_lib as skn
...
def buildSnakeFace(*args):
    ...
    hood_r = deformer.spline(SPLN_Name='hood_R', SPLN_Size=X*4, SPLN_Dist=3.0, SPLN_Falloff=0, 
                             SPLN_Prnt=['head_jnt','upperC_jnt_04', 'upperB_jnt_02'],
...
#cmds.file('/Volumes/VFX/Projects/Legend_of_Santa_Paws/Assets/Development/Artist/shawn_patapoff/faceRig_body_test/CharactersWork/Slither/RIG/Slither_skeleton_template_working0003.mb',f=True,o=True)
#buildSnakeFace()
